...
export function createSessionTools(sessions) {
  const service = new SessionService(sessions);
  ...
  return {
    search_sessions: {
      ...
      handler: async (args) => service.searchSessions(args.query, args.limit, args.cursor)
    },
    ...
    search_services: {
      ...
      handler: async (args) => service.searchServices(args.query, args.limit, args.cursor)
    },
    ...
    get_session_details: {
      ...
      handler: async (args) => service.getSessionDetails(args.session_code)
    },
    ...
    list_categories: {
      ...
      handler: async (args) => service.listCategories(args.category)
    },
    ...
    get_sessions_by_service: {
      ...
      handler: async (args) => service.getSessionsByService(args.service_name, args.limit, args.cursor)
    },
    ...
    get_sessions_by_level: {
      ...
      handler: async (args) => service.getSessionsByLevel(args.level, args.limit, args.cursor)
    },
    ...
    get_sessions_by_role: {
      ...
      handler: async (args) => service.getSessionsByRole(args.role, args.limit, args.cursor)
    },
    ...
    get_sessions_by_industry: {
      ...
      handler: async (args) => service.getSessionsByIndustry(args.industry, args.limit, args.cursor)
    },
    ...
    get_sessions_by_segment: {
      ...
      handler: async (args) => service.getSessionsBySegment(args.segment, args.limit, args.cursor)
    },
    ...
    get_sessions_by_feature: {
      ...
      handler: async (args) => service.getSessionsByFeature(args.feature, args.limit, args.cursor)
    },
    ...
    get_sessions_by_topic: {
      ...
      handler: async (args) => service.getSessionsByTopic(args.topic, args.limit, args.cursor)
    },
    ...
    get_sessions_by_area_of_interest: {
      ...
      handler: async (args) => service.getSessionsByAreaOfInterest(args.area_of_interest, args.limit, args.cursor)
    },
    ...
    search_speakers: {
      ...
      handler: async (args) => service.searchSpeakers(args.speaker_name, args.limit, args.cursor)
    }
  };
}
